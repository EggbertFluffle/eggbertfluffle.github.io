...
Step`,v,p,I=`So I very quickly fell out of the habit of writing once a week.
...
true, mezzaluna. Well gosh, what is a mezzaluna anyhow?`,b,n,H='<img style="width: 30%;" src="/images/mezzaluna.png" alt="An evenly curved blade with wooden handles on both ends"/>',y,f,j=`It’s just a knife, with a curved blade, used to cut herbs,
vegetables, and sometimes pizza. It also seems to be a style of pasta,
simmilar to ravioli (my favorite btw), but that’s unrelated.`,z,r,P="Blogavator Pitch",x,w,q=`But why do <a href="https://squi.bid">Squibid</a> and I have a mezzaluna? Well the more proper way
...
could ever want. Now how about that.`,k,u,A="The Future is Bright",M,c,S=`Development started super strong, with a lot of reasearch, reading
...
on.`,C,g,W=`If you wan’t to <a href="https://github.com/MezzalunaWM/Mezzaluna">check the project out</a>, you’ll just need <a href="https://gitlab.freedesktop.org/wlroots/wlroots">wlroots-0.19</a>,
...
reading or exploring C projects you never knew you needed.`;return{c(){o=l("h1"),o.textContent=L,v=d(),p=l("p"),p.innerHTML=I,b=d(),n=l("div"),n.innerHTML=H,y=d(),f=l("p"),f.textContent=j,z=d(),r=l("h2"),r.textContent=P,x=d(),w=l("p"),w.innerHTML=q,k=d(),u=l("h2"),u.textContent=A,M=d(),c=l("p"),c.innerHTML=S,C=d(),g=l("p"),g.innerHTML=W,this.h()},l(e){o=s(e,"H1",{id:!0,"data-svelte-h":!0}),h(o)!=="svelte-93f9jn"&&(o.textContent=L),v=m(e),p=s(e,"P",{"data-svelte-h":!0}),h(p)!=="svelte-1me4v6t"&&(p.innerHTML=I),b=m(e),n=s(e,"DIV",{style:!0,"data-svelte-h":!0}),h(n)!=="svelte-ncebbg"&&(n.innerHTML=H),y=m(e),f=s(e,"P",{"data-svelte-h":!0}),h(f)!=="svelte-afyf9g"&&(f.textContent=j),z=m(e),r=s(e,"H2",{id:!0,"data-svelte-h":!0}),h(r)!=="svelte-g87auz"&&(r.textContent=P),x=m(e),w=s(e,"P",{"data-svelte-h":!0}),h(w)!=="svelte-74wuam"&&(w.innerHTML=q),k=m(e),u=s(e,"H2",{id:!0,"data-svelte-h":!0}),h(u)!=="svelte-eamj6b"&&(u.textContent=A),M=m(e),c=s(e,"P",{"data-svelte-h":!0}),h(c)!=="svelte-plgyf7"&&(c.innerHTML=S),C=m(e),g=s(e,"P",{"data-svelte-h":!0}),h(g)!=="svelte-15ni27v"&&(g.innerHTML=W),this.h()},h(){_(o,"id","mezzaluna-the-penultimate-step"),B(n,"display","flex"),B(n,"justify-content","center"),_(r,"id","blogavator-pitch"),_(u,"id","the-future-is-bright")},m(e,t){a(e,o,t),a(e,v,t),a(e,p,t),a(e,b,t),a(e,n,t),a(e,y,t),a(e,f,t),a(e,z,t),a(e,r,t),a(e,x,t),a(e,w,t),a(e,k,t),a(e,u,t),a(e,M,t),a(e,c,t),a(e,C,t),a(e,g,t)},p:T,i:T,o:T,d(e){e&&(i(o),i(v),i(p),i(b),i(n),i(y),i(f),i(z),i(r),i(x),i(w),i(k),i(u),i(M),i(c),i(C),i(g))}}}class G extends E{constructor(o){super(),F(this,o,null,U,N,{})}}export{G as component};
